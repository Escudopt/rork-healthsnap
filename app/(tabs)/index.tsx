...
const createStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  segmentedControl: {
    ...
    borderRadius: 14,
    padding: 4,
    shadowColor: isDark ? 'rgba(59, 130, 246, 0.2)' : 'rgba(0, 122, 255, 0.1)',
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: isDark ? 0.3 : 0.08,
    shadowRadius: isDark ? 8 : 12,
    elevation: isDark ? 4 : 3,
    borderWidth: 1,
    borderColor: isDark ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 122, 255, 0.08)',
  ...
  activeSegmentButton: {
    ...
    backgroundColor: isDark ? 'rgba(22, 24, 33, 0.9)' : 'rgba(255, 255, 255, 0.95)',
  },
  segmentText: {
    fontSize: 13,
    fontWeight: '600' as const,
