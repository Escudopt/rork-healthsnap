      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        >
          ...
          <Animated.View style={[
            ...
            {/* Enhanced Daily Progress Menu */}
            <View style={styles.dailyProgressMenu}>
              {/* Main Progress Overview */}
              <View style={[styles.progressOverviewCard, { backgroundColor: colors.surfaceElevated }]}>
                <View style={styles.progressOverviewHeader}>
                  <Text style={[styles.progressOverviewTitle, { color: colors.text }]}>Progresso do Dia</Text>
                  <View style={[styles.progressBadge, { 
                    backgroundColor: todayCalories >= dailyGoal ? '#34C759' : todayCalories >= dailyGoal * 0.8 ? '#FF9500' : '#007AFF'
                  }]}>
                ...
                <View style={styles.progressOverviewContent}>
                  <View style={styles.calorieDisplay}>
                    ...
                    <Text style={[styles.calorieUnit, { color: colors.textSecondary }]}>de {dailyGoal.toLocaleString()} kcal</Text>
                  </View>
                  ...
                  <View style={styles.progressBarContainer}>
                    <View style={[styles.progressBarTrack, { backgroundColor: colors.surfaceSecondary }]}>
                      <View 
                        style={[
                          ...
                          {
                            width: `${Math.min((todayCalories / dailyGoal) * 100, 100)}%`,
                            backgroundColor: todayCalories >= dailyGoal ? '#34C759' : todayCalories >= dailyGoal * 0.8 ? '#FF9500' : '#007AFF'
                          }
                        ]} 
                      />
                    ...
                    <Text style={[styles.remainingText, { color: colors.textSecondary }]}>
                      {todayCalories >= dailyGoal 
                        ? `+${(todayCalories - dailyGoal).toLocaleString()} kcal acima da meta`
                        : `${(dailyGoal - todayCalories).toLocaleString()} kcal restantes`
                      }
                    </Text>
                  </View>
                </View>
              ...
              <View style={styles.metricsGrid}>
                <View style={[styles.metricCard, { backgroundColor: colors.surfaceElevated }]}>
                  <View style={styles.metricHeader}>
                    <View style={[styles.metricIcon, { backgroundColor: '#FF3B30' }]}>
                      <Flame color="white" size={14} strokeWidth={2.5} />
                    </View>
                    <Text style={[styles.metricTitle, { color: colors.text }]}>Calorias</Text>
                  </View>
                  <Text style={[styles.metricValue, { color: colors.text }]}>
                    {todayCalories.toLocaleString()}
                  </Text>
                  <Text style={[styles.metricSubtitle, { color: colors.textSecondary }]}>kcal consumidas</Text>
                  <View style={styles.metricProgress}>
                    <View style={[styles.metricProgressBar, { backgroundColor: colors.surfaceSecondary }]}>
                      <View 
                        style={[
                ...
                <View style={[styles.metricCard, { backgroundColor: colors.surfaceElevated }]}>
                  <View style={styles.metricHeader}>
                    <View style={[styles.metricIcon, { backgroundColor: '#34C759' }]}>
                      <Activity color="white" size={14} strokeWidth={2.5} />
                    </View>
                    <Text style={[styles.metricTitle, { color: colors.text }]}>Refeições</Text>
                  </View>
                  <Text style={[styles.metricValue, { color: colors.text }]}>
                    {todayMeals.length}
                  </Text>
                  <Text style={[styles.metricSubtitle, { color: colors.textSecondary }]}>registradas hoje</Text>
                  <View style={styles.metricProgress}>
                    <View style={[styles.metricProgressBar, { backgroundColor: colors.surfaceSecondary }]}>
                      <View 
                        style={[
                          styles.metricProgressFill,
                          {
                            width: `${Math.min((todayMeals.length / 6) * 100, 100)}%`,
                ...
                <View style={[styles.metricCard, { backgroundColor: colors.surfaceElevated }]}>
                  <View style={styles.metricHeader}>
                    <View style={[styles.metricIcon, { backgroundColor: '#007AFF' }]}>
                      <TrendingUp color="white" size={14} strokeWidth={2.5} />
                    </View>
                    <Text style={[styles.metricTitle, { color: colors.text }]}>Média Semanal</Text>
                  </View>
                  <Text style={[styles.metricValue, { color: colors.text }]}>
                    {weeklyAverage.toLocaleString()}
                  </Text>
                  <Text style={[styles.metricSubtitle, { color: colors.textSecondary }]}>kcal por dia</Text>
                  <View style={styles.metricProgress}>
                    <View style={[styles.metricProgressBar, { backgroundColor: colors.surfaceSecondary }]}>
                      <View 
                        style={[
                          styles.metricProgressFill,
                          {
                            width: `${Math.min((weeklyAverage / dailyGoal) * 100, 100)}%`,
                ...
                <View style={[styles.metricCard, { backgroundColor: colors.surfaceElevated }]}>
                  <View style={styles.metricHeader}>
                    <View style={[styles.metricIcon, { backgroundColor: '#FF9500' }]}>
                      <Target color="white" size={14} strokeWidth={2.5} />
                    </View>
                    <Text style={[styles.metricTitle, { color: colors.text }]}>Meta Diária</Text>
                  </View>
                  <Text style={[styles.metricValue, { color: colors.text }]}>
                    {dailyGoal.toLocaleString()}
                  </Text>
                  <Text style={[styles.metricSubtitle, { color: colors.textSecondary }]}>kcal objetivo</Text>
                  <TouchableOpacity 
                    style={styles.metricAction}
                    onPress={handleGoalPress}
                    activeOpacity={0.7}
                  >
                    <Text style={[styles.metricActionText, { color: colors.primary }]}>Ajustar</Text>
                  </TouchableOpacity>
                </View>
              </View>

              {/* Quick Stats Summary */}
              <View style={[styles.quickStatsCard, { backgroundColor: colors.surfaceElevated }]}>
                <Text style={[styles.quickStatsTitle, { color: colors.text }]}>Resumo Rápido</Text>
                <View style={styles.quickStatsRow}>
                  <View style={styles.quickStat}>
                    <Text style={[styles.quickStatValue, { color: todayCalories >= dailyGoal ? '#34C759' : '#FF9500' }]}>
                      {todayCalories >= dailyGoal ? '✓' : Math.round((todayCalories / dailyGoal) * 100) + '%'}
                    </Text>
                    <Text style={[styles.quickStatLabel, { color: colors.textSecondary }]}>Meta</Text>
                  </View>
                  <View style={[styles.quickStatDivider, { backgroundColor: colors.surfaceSecondary }]} />
                  <View style={styles.quickStat}>
                    <Text style={[styles.quickStatValue, { color: colors.text }]}>
                      {todayMeals.length}
                    </Text>
                    <Text style={[styles.quickStatLabel, { color: colors.textSecondary }]}>Refeições</Text>
                  </View>
                  <View style={[styles.quickStatDivider, { backgroundColor: colors.surfaceSecondary }]} />
                  <View style={styles.quickStat}>
                    <Text style={[styles.quickStatValue, { color: colors.text }]}>
                      {weeklyAverage > 0 ? Math.round(((todayCalories - weeklyAverage) / weeklyAverage) * 100) : 0}%
                    </Text>
                    <Text style={[styles.quickStatLabel, { color: colors.textSecondary }]}>vs Média</Text>
                  </View>
                </View>
              </View>
